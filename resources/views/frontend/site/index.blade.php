    ...
    <div id="swiper1" class="swiper-container">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <div class="slide-bg swiper-lazy" data-background="frontend/images/slides/1.jpg"></div>
                <!-- Preloader image -->
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-10 col-md-8 col-lg-6 col-sm-offset-2 col-md-offset-4 col-lg-offset-6 slide-desc-col animated fadeInDown slide-desc-1">
                            ...
                            <div class="slide-buttons slide-buttons-right">
                                ...
                                <a href="estate-details-right-sidebar.html" class="navigation-box navigation-box-more slide-more">
                                    <div class="navigation-triangle"></div>
            ...
            <div class="swiper-slide">
                <div class="slide-bg swiper-lazy" data-background="frontend/images/slides/2.jpg"></div>
                <!-- Preloader image -->
                <div class="swiper-lazy-preloader swiper-lazy-preloader-white"></div>
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12 col-sm-10 col-md-8 col-lg-6 slide-desc-col animated slide-desc-2">
                            <div class="slide-desc pull-left">
                                ...
                                <div class="slide-desc-params">
                                    <div class="slide-desc-area">
                                        <img src="frontend/images/area-icon.png" alt="" />350m<sup>2</sup>
                                    </div>
                                    <div class="slide-desc-rooms">
                                    ...
                                    <div class="slide-desc-parking">
                                        <img src="frontend/images/parking-icon.png" alt="" />2
                                    </div>
                                </div>
                                <div class="slide-desc-price">
                                    $ 650 000
                ...
                <div class="video-slide">
                    <video poster="frontend/images/slides/2.jpg" preload="auto" loop autoplay muted>
                        <source src='frontend/images/slides/2.mp4' type='video/mp4' />
                    </video>
                </div>
            </div>
            <div class="swiper-slide">
                <div class="slide-bg swiper-lazy" data-background="frontend/images/slides/3.jpg"></div>
                <!-- Preloader image -->
                <div class="swiper-lazy-preloader swiper-lazy-preloader-white"></div>
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12 col-sm-10 col-md-8 col-lg-6 col-sm-offset-1 col-md-offset-2 col-lg-offset-3 slide-desc-col animated slide-desc-3">
                            <div class="slide-desc center-block">
                                ...
                                <div class="slide-desc-params">
                                    <div class="slide-desc-area">
                                        <img src="frontend/images/area-icon.png" alt="" />70m<sup>2</sup>
                                    </div>
                                    <div class="slide-desc-rooms">
    ...
    <div class="featured-offers-container">
        <div class="owl-carousel" id="featured-offers-owl">
            ...
            <div class="featured-offer-col">
                <div class="featured-offer-front">
                    <div class="featured-offer-photo">
                        <img src="frontend/images/featured-offer2.jpg" alt="" />
                        <div class="type-container">
                            <div class="estate-type">apartment</div>
                            <div class="transaction-type">sale</div>
                        </div>
            ...
            <div class="featured-offer-col">
                <div class="featured-offer-front">
                    <div class="featured-offer-photo">
                        <img src="frontend/images/featured-offer3.jpg" alt="" />
                        <div class="type-container">
                            <div class="estate-type">house</div>
                            <div class="transaction-type">sale</div>
                        </div>
                    ...
                    <div class="featured-offer-params">
                        <div class="featured-area">
                            <img src="frontend/images/area-icon.png" alt="" />250m<sup>2</sup>
                        </div>
                        <div class="featured-rooms">
                            <img src="frontend/images/rooms-icon.png" alt="" />7
                        </div>
                        <div class="featured-baths">
                            <img src="frontend/images/bathrooms-icon.png" alt="" />3
                        </div>
            ...
            <div class="featured-offer-col">
                <div class="featured-offer-front">
                    <div class="featured-offer-photo">
                        <img src="frontend/images/featured-offer4.jpg" alt="" />
                        <div class="type-container">
                            <div class="estate-type">apartment</div>
                            <div class="transaction-type">sale</div>
                        </div>
                    ...
                    <div class="featured-offer-params">
                        <div class="featured-area">
                            <img src="frontend/images/area-icon.png" alt="" />40m<sup>2</sup>
                        </div>
                        <div class="featured-rooms">
            ...
            <div class="featured-offer-col">
                <div class="featured-offer-front">
                    <div class="featured-offer-photo">
                        <img src="frontend/images/featured-offer5.jpg" alt="" />
                        <div class="type-container">
                            <div class="estate-type">apartment</div>
                            <div class="transaction-type">sale</div>
                        </div>
                    ...
                    <div class="featured-offer-params">
                        <div class="featured-area">
                            <img src="frontend/images/area-icon.png" alt="" />80m<sup>2</sup>
                        </div>
                        <div class="featured-rooms">
                            <img src="frontend/images/rooms-icon.png" alt="" />3
                        </div>
            ...
            <div class="featured-offer-col">
                <div class="featured-offer-front">
                    <div class="featured-offer-photo">
                        <img src="frontend/images/featured-offer6.jpg" alt="" />
                        <div class="type-container">
                            <div class="estate-type">apartment</div>
                            <div class="transaction-type">sale</div>
                        </div>
            ...
            <div class="featured-offer-col">
                <div class="featured-offer-front">
                    <div class="featured-offer-photo">
                        <img src="frontend/images/featured-offer7.jpg" alt="" />
                        <div class="type-container">
                            <div class="estate-type">house</div>
                            <div class="transaction-type">sale</div>
                        </div>
    ...
    <div class="container margin-top-90">
        <div class="row">
            <div class="col-xs-12 owl-carousel" id="testimonials-owl">
                ...
                <div class="testimonial">
                    <img src="frontend/images/testimonials2.jpg" alt="" class="testimonials-photo" />
                    <div class="testimonials-content">
                ...
                <div class="testimonial">
                    <img src="frontend/images/testimonials3.jpg" alt="" class="testimonials-photo" />
                    <div class="testimonials-content">
        ...
        <div class="row">
            <div class="col-md-12 col-lg-6 blog-grid1-left-col">
                <article class="blog-grid1-item zoom-cont">
                    <figure class="">
                        <a href="blog-right-sidebar.html"><img src="frontend/images/blog-grid1a.jpg" alt="" class="zoom" /></a>
                    </figure>
            ...
            <div class="col-md-12 col-lg-6 blog-grid1-right-col">
                <article class="blog-grid1-item zoom-cont">
                    <figure class="">
                        <a href="blog-right-sidebar.html"><img src="frontend/images/blog-grid1b.jpg" alt="" class="zoom" /></a>
                    </figure>
                    <div class="blog-grid1-post-content">
                        <div class="blog-grid1-topline">
                            <div class="blog-grid1-author pull-left"><i class="fa fa-user"></i>Admin</div>
            ...
            <div class="col-md-12 col-lg-6 blog-grid1-left-col">
                <article class="blog-grid1-item zoom-cont">
                    ...
                    <figure class="">
                        <a href="blog-right-sidebar.html"><img src="frontend/images/blog-grid1e.jpg" alt="" class="zoom" /></a>
                    </figure>
                </article>
            </div>
            <div class="col-md-12 col-lg-6 blog-grid1-right-col">
                <article class="blog-grid1-item zoom-cont">
                    ...
                    <figure class="">
                        <a href="blog-right-sidebar.html"><img src="frontend/images/blog-grid1d.jpg" alt="" class="zoom" /></a>
                    </figure>
                </article>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function init() {
        ...
        mapInitAddress("narodowa 18 Pruszków", "featured-map1", "frontend/images/pin-house.png", false);

        //mapInit(40.6128,-73.7903,"featured-map1","frontend/images/pin-house.png", false);
        mapInit(40.7222, -73.7903, "featured-map2", "frontend/images/pin-apartment.png", false);
        mapInit(41.0306, -73.7669, "featured-map3", "frontend/images/pin-land.png", false);
        mapInit(41.3006, -72.9440, "featured-map4", "frontend/images/pin-commercial.png", false);
        mapInit(42.2418, -74.3626, "featured-map5", "frontend/images/pin-house.png", false);
        mapInit(38.8974, -77.0365, "featured-map6", "frontend/images/pin-apartment.png", false);
        mapInit(38.7860, -77.0129, "featured-map7", "frontend/images/pin-house.png", false);

        mapInit(41.2693, -70.0874, "grid-map1", "frontend/images/pin-house.png", false);
        mapInit(33.7544, -84.3857, "grid-map2", "frontend/images/pin-apartment.png", false);
        mapInit(33.7337, -84.4443, "grid-map3", "frontend/images/pin-land.png", false);
        mapInit(33.8588, -84.4858, "grid-map4", "frontend/images/pin-commercial.png", false);
        mapInit(34.0254, -84.3560, "grid-map5", "frontend/images/pin-apartment.png", false);
        mapInit(40.6128, -73.9976, "grid-map6", "frontend/images/pin-house.png", false);
    }
</script>
