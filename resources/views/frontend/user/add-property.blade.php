            ...
            <div class="row">
                    ...
                    <div class="dark-col margin-top-60">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-4 col-md-6 col-lg-4 margin-top-15">
                                ...
                                <label for="c1"><span></span>Air Conditioning</label>
                                <br/>
                                <input type="checkbox" id="c2" name="cc" class="main-checkbox" />
                                <label for="c2"><span></span>Internet</label>
                                <br/>
                                ...
                                <label for="c4"><span></span>Balcony</label>
                                <br/>
                                <input type="checkbox" id="c5" name="cc" class="main-checkbox" />
                                <label for="c5"><span></span>Roof Terrace</label>
                                <br/>
                            ...
                            <div class="col-xs-12 col-sm-4 col-md-6 col-lg-4 margin-top-15">
                                ...
                                <label for="c13"><span></span>Another Option</label>
                                <br/>
                                <input type="checkbox" id="c14" name="cc" class="main-checkbox" />
                                <label for="c14"><span></span>Another Option</label>
                                <br/>
                                <input type="checkbox" id="c15" name="cc" class="main-checkbox" />
                                <label for="c15"><span></span>Another Option</label>
                                <br/>
                                <input type="checkbox" id="c16" name="cc" class="main-checkbox" />
                                <label for="c16"><span></span>Another Option</label>
                                <br/>
                                <input type="checkbox" id="c17" name="cc" class="main-checkbox" />
                                <label for="c17"><span></span>Another Option</label>
                                <br/>
                ...
                <div class="col-xs-12 col-md-6 margin-top-xs-60 margin-top-sm-60">
                    ...
                    <div class="dark-col margin-top-60">
                        ...
                        <p class="negative-margin bold-indent">Or drag the marker to property position
                            <p>
